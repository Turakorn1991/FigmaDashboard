...
export function Sidebar({ activePage, onPageChange }: SidebarProps) {
  ...
  const reports = [
    ...
    { id: 2, label: "ยอดการขนย้าย/ส่งมอบอาวุธหรือวัตถุ ตามแบบ อ.10" },
    { id: 3, label: "ยอดอนุญาตให้สั่งหรือนำเข้ามาในราชอาณาจักรซึ่งวัตถุหรืออาวุธ" },
    { id: 4, label: "ติดตามสถานะการขนย้ายตามหนังสืออนุญาตขนย้ายอาวุธ ที่ยังไม่หมดอายุ" },
    { id: 5, label: "จำนวนหนังสืออนุญาตให้ สั่ง ขาย ขนย้าย อาวุธและวัตถุ" },
    { id: 6, label: "ยอดการแจ้งนำเข้ามาในราชอาณาจักรซึ่งวัตถุหรืออาวุธ ตามแบบ อ.8" },
  ];
