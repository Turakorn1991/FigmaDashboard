...
const MOCK: RequestRow[] = Array.from({ length: 11 }, (_, i) => ({
  id: i + 1,
  refNo: `อ.15-2568-${String(i + 1).padStart(4, "0")}`,
  company: ["บริษัท ซีเคียวริตี้ อินดัสทรี จำกัด", "บริษัท ยุทธนา อาวุธ จำกัด", "ห้างหุ้นส่วนจำกัด วิศวกรรมป้องกัน", "บริษัท มิลิทารี่ เทคโนโลยี จำกัด"][i % 4],
  taxId: ["0105562890123", "0105549678901", "0105551789012", "0105560345678"][i % 4],
  submitDate: `${1 + i} มิ.ย. 2568`,
  status: ["reviewing", "approved", "pending", "rejected"][i % 4],
  details: "คำขออนุญาตขายหรือจำหน่ายอาวุธปืนสั้นและกระสุน ให้แก่หน่วยงานราชการภายในราชอาณาจักร",
}));

export function PageRequestA15() {
  ...
  return (
    <div style={{ fontFamily: FF }}>
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 20, fontWeight: 700, color: "#0E1119" }}>คำขออนุญาต แบบ อ.15</div>
        <div style={{ fontSize: 13, color: "#8B8E95", marginTop: 4 }}>คำขออนุญาตขายหรือจำหน่ายอาวุธฯ ในราชอาณาจักร</div>
      </div>
      ...
      <div style={{ background: "#fff", borderRadius: 16, boxShadow: "0 1px 3px rgba(15,23,42,0.08)", overflow: "hidden" }}>
        <div style={{ padding: "14px 20px", borderBottom: "1px solid #F0F0F0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: 14, fontWeight: 600, color: "#0E1119" }}>รายการคำขออนุญาต แบบ อ.15</span>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 }}>
          <div style={{ background: "#fff", borderRadius: 16, width: 620, maxWidth: "90vw", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.15)" }}>
            <div style={{ padding: "20px 24px", borderBottom: "1px solid #F3F4F6", display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div><div style={{ fontSize: 16, fontWeight: 700, color: "#0E1119" }}>รายละเอียดคำขออนุญาต แบบ อ.15</div><div style={{ fontSize: 12, color: "#8B8E95" }}>คำขออนุญาตขายหรือจำหน่ายอาวุธฯ ในราชอาณาจักร</div></div>
